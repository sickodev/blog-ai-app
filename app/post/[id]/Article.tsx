        ...
        <article className='text-wh-500 leading-8'>
            ...
            {isEditable && (
                <div className='border-2 rounded-md bg-wh-50 p-3 mb-3'>
                    ...
                    <p className='my-1 o-0 text-xs'>
                        What type of writer do you want?
                    </p>
                    <div className='flex gap-5 justify-between'>
                        <input
                            type='text'
                            className='border-2 rounded-md bg-wh-50 px-3 w-full py-1'
                            placeholder='Role'
                            onChange={(e) => {
            ...
            <div
                className={
                    isEditable ? "border-2 bg-wh-50 p-3" : "w-full max-w-full"
                }
            >
                {isEditable && (
                    <>
            ...
            {contentError && <p className='mt-1 text-wh-500'>{contentError}</p>}
        </article>
    );
};
